---
title: 'The Data Tender: Bridging the Gap Between Sea and Cloud'
date: '2026-02-01'
tags:
  - python
  - pyside6
...
draft: false
summary: >-
  How we leveraged Starlink to modernize NOAA data pipelines, moving from thumb drives to real-time AWS S3 uploads utilizing ruggedized laptops and a custom QML application.
authors:
  - default
---
